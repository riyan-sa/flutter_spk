            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildPanduanStep(
                    '1',
                    'Masukkan nilai kriteria secara objektif.',
                  ),
                  const SizedBox(height: 16),
                  _buildPanduanStep(
                    '2',
                    'Isi kuesioner minat dan penguasaan teknologi.',
                  ),
                  const SizedBox(height: 16),
                  _buildPanduanStep(
                    '3',
                    'Sistem akan otomatis menghitung rekomendasi terbaik dengan metode WASPAS.',
                  ),
                ],
              ),
            ),
                    ...
                    child: Row(
                      children: const [
                        ...
                        Expanded(
                          flex: 2,
                          child: Align(
                            // ➔ SUDAH DIPERBAIKI MENGGUNAKAN WIDGET ALIGN (BARIS 186)
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    flex: 2,
                                    child: Align(
                                      // ➔ SUDAH DIPERBAIKI MENGGUNAKAN WIDGET ALIGN (BARIS 237)
                                      alignment: Alignment.centerRight,
                                      child: Text(
